...
public class Gun : MonoBehaviour
{
    ...
    public void ShootGun(Transform director)
    {
        ...
        if (shotgun)
        {
            ...
            SpawnBullet(director.position,Quaternion.Euler(director.eulerAngles)*Quaternion.AngleAxis(330.0f  , Vector3.forward));
            SpawnBullet(director.position,Quaternion.Euler(director.eulerAngles)*Quaternion.AngleAxis(340.0f , Vector3.forward));
            SpawnBullet(director.position,Quaternion.Euler(director.eulerAngles)*Quaternion.AngleAxis(350.0f , Vector3.forward));
            SpawnBullet(director.position,Quaternion.Euler(director.eulerAngles)*Quaternion.AngleAxis(0.0f , Vector3.forward));
            SpawnBullet(director.position,Quaternion.Euler(director.eulerAngles)*Quaternion.AngleAxis(10.0f , Vector3.forward));
            SpawnBullet(director.position,Quaternion.Euler(director.eulerAngles)*Quaternion.AngleAxis(20.0f , Vector3.forward));
        }
        else
